...
from robolab.tasks.manager_based.amp.mdp.symmetry import e1


@configclass
class E1RslRlOnPolicyRunnerAmpCfg(RslRlOnPolicyRunnerAmpCfg):
    experiment_name = "e1_amp"
    wandb_project   = "e1_amp"
    logger = "tensorboard"
    ...
    algorithm = RslRlPpoAmpAlgorithmCfg(
        ...
        symmetry_cfg=RslRlSymmetryCfg(
            ...
            data_augmentation_func=e1.compute_symmetric_states,
        ),
        amp_cfg=RslRlAmpCfg(
